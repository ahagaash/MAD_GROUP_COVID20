...
public class MyAdapter1 extends RecyclerView.Adapter<FoodViewHolder>{
    ...
    public MyAdapter1(Context mContext, List<FoodData> myFoodList) {
    ...
    public void onBindViewHolder(@NonNull final FoodViewHolder holder, final int i) {
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext,Food_Description.class);
...
class FoodViewHolder1 extends RecyclerView.ViewHolder{
    ...
    public FoodViewHolder1(View itemView){
        super(itemView);
